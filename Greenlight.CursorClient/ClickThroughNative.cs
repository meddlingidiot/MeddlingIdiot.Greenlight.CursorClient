...
/// testing — clicks land on the halo instead of on whatever the cursor is actually over.
/// </remarks>
...
internal static class ClickThroughNative
{
    ...
    public static void Apply(IntPtr hwnd)
    {
        ...
        // uniform fade"; the halo's own translucency comes from how they are drawn.
    ...
    /// startup gets you a halo that is on top until the first time somebody clicks the
