...
/// <summary>
/// Whether the halo comes back when Windows does. One value under the current user's
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Cursor Halo";

    /// <summary>Whether Windows is currently set to start the halo.</summary>
    ...
    /// <summary>Ask Windows to start the halo, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.CursorClient\current\Greenlight.LavaLampClient.exe</c>,
